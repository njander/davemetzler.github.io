...
$("#bottombar-toggle-btn").click(function() {
  $("#bottombar").toggle();
  map.invalidateSize();
  return false;
});
...
var mapquestHYB = L.tileLayer('http://{s}.tile.stamen.com/toner-lite/{z}/{x}/{y}.png', {
...
var boroughs = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    boroughSearch.push({
      name: layer.feature.properties.NBHD_NAME,
      source: "Boroughs",
      id: L.stamp(layer),
...
var theaters = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Name</th><td>" + feature.properties.REC_NAME + "</td></tr>" +
      "<tr><th>Phone</th><td>" + feature.properties.PHONE + "</td></tr>" +
       "<tr><th>Address</th><td>" + feature.properties.ADDRESS_LI + "</td></tr>" +
        "<tr><th>Website</th><td><a class='url-break' href='http://" + feature.properties.NEWS_LINK + "' target='_blank'>" + 'Click Here' + "</a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
      ...
      $("#feature-list tbody").append('<tr class="feature-row" id="'+L.stamp(layer)+'"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/theater.png"></td><td class="feature-name">'+layer.feature.properties.REC_NAME+'</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      theaterSearch.push({
        name: layer.feature.properties.REC_NAME,
        address: layer.feature.properties.ADDRESS_LI,
        source: "Theaters",
        id: L.stamp(layer),
...
$.getJSON("data/rec_center.geojson", function (data) {
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/theater.png' width='24' height='28'>&nbsp;Rec Centers</h4>",
