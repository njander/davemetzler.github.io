...
L.Control.Distance = L.Control.extend({
	...
	onAdd: function(map) {
		...
		var link = this._link = this._createButton('Measure', 'leaflet-control-distance leaflet-control-distance-edit', container, cb, this);
	...
	_d2txt: function(d) {
		if (d < 1609.344)
			return (d*3.28084).toFixed(0) + ' ft';
		else
			return ((d*3.28084)/5280).toFixed(1) + ' Mi';
	},
